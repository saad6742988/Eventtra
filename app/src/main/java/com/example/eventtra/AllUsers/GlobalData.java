...
public class GlobalData extends Application {
     ...
     public MyEvent globalEvent;
     public subEventsModel globalSubEvent;
    public String[] eventCategories = {"Art", "E-Gaming", "Education", "Fashion", "Food & Drink", "Health & Wellness", "Music", "Socials", "Sports", "Technical"};
